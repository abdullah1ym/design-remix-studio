...
const defaultExercises: Exercise[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "q3", prompt: "ما الجملة التي سمعتها؟", audioPlaceholder: "ركبَ السيارة", options: ["ركبَ السيارة", "ركنَ السيارة"], correctAnswer: 0 },
      { id: "q4", prompt: "ما الجملة التي سمعتها؟", audioPlaceholder: "قال علي نعم", options: ["قال علي نعم", "قال علي نام"], correctAnswer: 0 },
      { id: "q5", prompt: "ما الجملة التي سمعتها؟", audioPlaceholder: "سكن البيت", options: ["سكن البيت", "سكن البنت"], correctAnswer: 0 },
      { id: "q6", prompt: "ما الجملة التي سمعتها؟", audioPlaceholder: "جلسَ الولد", options: ["جلسَ الولد", "جلسَ الورد"], correctAnswer: 0 },
      { id: "q7", prompt: "ما الجملة التي سمعتها؟", audioPlaceholder: "قرأَ أحمد كتابًا", options: ["قرأَ أحمد كتابًا", "قرأَ أحمد خطابًا"], correctAnswer: 0 },
