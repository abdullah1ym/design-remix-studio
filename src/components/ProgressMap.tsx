...
import { Check, Lock, Play, Star, Zap, Anchor, Fish, Shell, Waves } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl bg-background/95 backdrop-blur-xl border-border">
        ...
        <div className="relative h-[500px] rounded-xl overflow-hidden bg-gradient-to-b from-primary/30 via-background to-turquoise/10">
