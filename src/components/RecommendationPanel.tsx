      ...
      >
        ...
        <div className="pr-12">
          <h3 className="text-lg font-bold mb-2">
            Based on your answers, we recommend you start with Ocean Life Overview.
          </h3>
          <p className="text-sm text-muted-foreground mb-6">
            In this module you will explore through <span className="text-coral font-semibold">coral reef patterns</span> and impacts on marine ecosystems.
          </p>
        </div>
        ...
        <div className="flex items-center justify-between py-4 border-t border-border">
          <div>
            <p className="font-semibold text-sm">Activate Ocean Guide</p>
            <p className="text-xs text-muted-foreground">Displays tips and progress tracker</p>
          </div>
        ...
        {/* Map Section */}
        <div className="mt-4">
          <h4 className="font-semibold mb-2">Track your progress in the map view</h4>
          <p className="text-xs text-muted-foreground mb-4">
            The map is synced with your progress through the playlists.
          </p>
          
          <motion.div 
            className="relative h-24 rounded-xl overflow-hidden bg-gradient-to-r from-primary/30 via-turquoise/20 to-jellyfish/30 flex items-center justify-center cursor-pointer group"
